...
## [v0.1.1](https://github.com/tukaelu/zgsync/compare/v0.1.0...v0.1.1) - 2026-08-05
...
- test: improve test quality across all packages by @tukaelu in https://github.com/tukaelu/zgsync/pull/80
- chore(ci): harden GitHub Actions against supply chain risks by @tukaelu in https://github.com/tukaelu/zgsync/pull/85
- chore(ci): relax codecov patch threshold by @tukaelu in https://github.com/tukaelu/zgsync/pull/86
